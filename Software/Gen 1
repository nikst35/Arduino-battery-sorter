...
int dropperSelect (float resistance){
  if (resistance<=0.12){
    ...
    servoDropper1.attach(5);servoDropper2.attach(6);servoDropper3.attach(7);
    ...
    servoDropper1.attach(5);servoDropper2.attach(6);servoDropper3.attach(7);servoDropper4.attach(8);
